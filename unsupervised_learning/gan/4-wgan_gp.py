#!/usr/bin/env python3
"""Wasserstein GAN with gradient penalty and pretrained weights."""
...
class WGAN_GP(keras.Model):
    """Wasserstein GAN using gradient penalty."""
    ...
    def replace_weight(self, gen_h5, disc_h5):
        """Compatibility alias for replace_weights."""
    ...
    def get_interpolated_sample(self, real_sample, fake_sample):
        """Generate samples between real and fake samples."""
        u = tf.random.uniform(
            self.scal_shape
        )
